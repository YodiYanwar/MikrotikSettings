# apr/06/2017 11:14:53 by RouterOS 6.34.2
# software id = 9GFZ-WVU6
#
/interface bridge
add comment="Jaringan LAN" name=bridge-LAN
add name=bridge-WAN
/interface ethernet
set [ find default-name=ether3 ] l2mtu=1522 mac-address=D4:CA:6D:03:D4:A6 \
    name=ether2-ABSEN
set [ find default-name=ether4 ] l2mtu=1522 mac-address=D4:CA:6D:03:D4:A7 \
    name=ether3-LAN
set [ find default-name=ether5 ] l2mtu=1522 mac-address=D4:CA:6D:03:D4:A8 \
    name=ether4-LAN
...
add hotspot-address=192.168.3.1 html-directory=flash/hotspot name=hsprof1
add hotspot-address=192.168.11.1 html-directory=flash/hotspot name=hsprof2
add hotspot-address=192.168.22.1 html-directory=flash/hotspot name=hsprof3
add hotspot-address=192.168.33.1 html-directory=flash/hotspot name=hsprof4
add hotspot-address=192.168.44.1 html-directory=flash/hotspot name=hsprof5
...
add name=staf-15 rate-limit=640k shared-users=15 transparent-proxy=yes
/ip ipsec proposal
...
add address-pool=pool-44 disabled=no interface=vlanLecturer lease-time=30m \
    name=dhcp5
/ip hotspot
add address-pool=pool-03 disabled=no interface=bridge-LAN name=hotspot1 \
    profile=hsprof1
...
add address-pool=pool-33 disabled=no interface=vlanStudent name=\
    hs-vlanStudent profile=hsprof4
add address-pool=pool-44 disabled=no interface=vlanLecturer name=\
    hs-vlanLecturer profile=hsprof5
/port
set 0 name=serial0
/system logging action
set 1 disk-file-name=log
/interface bridge port
add bridge=bridge-WAN
...
/ip address
add address=103.60.180.186/29 network=103.60.180.184
add address=192.168.3.1/24 disabled=yes network=192.168.3.0
...
add name=siti password=siti637 profile=Staff server=hs-vlanStaff
add name=neng password=neng910 profile=Staff server=hs-vlanStaff
add name=rusdi password=rusdi253 profile=Pimpinan server=hs-vlanStaff
add name=hasan password=hasan846 profile=Pimpinan server=hs-vlanStaff
...
add name=afif password=afif468 profile=Pimpinan server=hs-vlanStaff
...
add name=rian password=rian983 profile=Others server=hs-vlanStaff
...
add name=rafly password=rafly295 profile=Mahasiswa server=hs-vlanStudent
add name=afandi password=afandi486 profile=Mahasiswa server=hotspot1
add name=indrawan password=indrawan359 profile=Mahasiswa server=\
    hs-vlanStudent
...
add name=refah password=refah357 profile=Mahasiswa server=hs-vlanStudent
...
add name=andika password=andika516 profile=Mahasiswa server=hs-vlanStudent
...
add name=shidqi password=shidqi879 profile=Mahasiswa server=hs-vlanStudent
...
add name=rony password=rony482 profile=Mahasiswa server=hs-vlanStudent
...
add name=arip password=arip015 profile=Mahasiswa server=hs-vlanStudent
...
add name=Firzanarko password=Firzanarko751 profile=Mahasiswa server=\
    hs-vlanStudent
...
add name=Syauqi password=Syauqi349 profile=Mahasiswa server=hs-vlanStudent
add name=Aslam password=Aslam617 profile=Mahasiswa server=hotspot1
add name=Fathan password=Fathan620 profile=Mahasiswa server=hs-vlanStudent
...
add name=Dicky password=Dicky397 profile=Mahasiswa server=hs-vlanStudent
...
add name=Fadilla password=Fadilla684 profile=Mahasiswa server=hs-vlanStudent
add name=Khonsa password=khonsa123 profile=Mahasiswa server=hotspot1
add name=Jordi password=Jordi361 profile=Mahasiswa server=hs-vlanStudent
...
add name=Adam password=Adam361 profile=Mahasiswa server=hs-vlanStudent
...
add name=Muzannif password=Muzannif294 profile=Mahasiswa server=\
    hs-vlanStudent
...
add name=Muhammad password=Muhammad341 profile=Mahasiswa server=\
    hs-vlanStudent
...
add name=Kemal password=Kemal485 profile=Mahasiswa server=hs-vlanStudent
...
add name=Aghniya password=Aghniya259 profile=Mahasiswa server=hs-vlanStudent
...
add name=ari password=ari942 profile=Pimpinan server=hs-vlanStaff
...
add name=Cahya password=Cahya381 profile=Mahasiswa server=hs-vlanStudent
...
add name=Khalifa password=Khalifa507 profile=Mahasiswa server=hs-vlanStudent
...
add name=bintang password=bintang849 profile=Pembina server=hs-vlanStaff
...
add name=Raihan password=Raihan197 profile=Mahasiswa server=hs-vlanStudent
...
add name=Hamdi password=Hamdi862 profile=Mahasiswa server=hs-vlanStudent
...
add name=Alfianoor password=Alfianoor753 profile=Mahasiswa server=\
    hs-vlanStudent
...
add name=galih password=galih576 profile=Dosen server=hs-vlanLecturer
...
add name=sulhani password=sulhani753 profile=Dosen server=hs-vlanLecturer
...
add name=yaser password=yaser495 profile=Dosen server=hs-vlanLecturer
...
add name=andang password=andang483 profile=Pimpinan server=hs-vlanStaff
...
add disabled=yes name=ahmad23 password=ahmad237 server=hotspot1
