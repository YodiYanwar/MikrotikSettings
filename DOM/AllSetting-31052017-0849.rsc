# may/31/2017 01:49:23 by RouterOS 6.37.5
...
add dns-name=hotspot.matrikulasi.id hotspot-address=192.168.3.1 name=\
    hsprofLAN
...
set [ find default=yes ] rate-limit=15360k/15360k shared-users=3
add idle-timeout=20m keepalive-timeout=5m name=Mahasiswa rate-limit=\
    "450k/450k 768k/768k 512k/512k 8/8" session-timeout=8h transparent-proxy=\
    yes
add idle-timeout=20m name=Staff rate-limit=\
    "512k/512k 1024k/1024k 768k/768k 10/10" session-timeout=8h shared-users=2 \
    transparent-proxy=yes
add idle-timeout=20m name=Pembina rate-limit=\
    "512k/512k 1024k/1024k 768k/768k 10/10" session-timeout=8h \
    transparent-proxy=yes
add idle-timeout=20m name=Pimpinan rate-limit=\
    "650k/650k 1024k/1024k 815k/815k 10/10" session-timeout=8h shared-users=2 \
    transparent-proxy=yes
add idle-timeout=2m name=Dosen rate-limit=\
    "512k/512k 1024k/1024k 768k/768k 10/10" session-timeout=8h shared-users=2 \
    transparent-proxy=yes
add idle-timeout=20m name=Others rate-limit=\
    "150k/150k 300k/300k 256k/256k 5/5" session-timeout=8h transparent-proxy=\
    yes
add idle-timeout=20m name=guest rate-limit=\
    "512k/512k 1024k/1024k 768k/768k 10/10" session-timeout=1h shared-users=5 \
    transparent-proxy=yes
...
add idle-timeout=20m keepalive-timeout=5m name=Labkom rate-limit=\
    15360k/15360k session-timeout=1h shared-users=31 transparent-proxy=yes
/ip pool
...
add action=drop chain=forward dst-port=137-139 in-interface=ether4-WAN \
    ip-protocol=tcp log=yes log-prefix="Blok 137-139 Ransomware BRIDGE" \
    mac-protocol=ip
add action=drop chain=forward dst-port=137-139 in-interface=ether4-WAN \
    ip-protocol=udp mac-protocol=ip
add action=drop chain=forward dst-port=445 in-interface=ether4-WAN \
    ip-protocol=tcp mac-protocol=ip
add action=drop chain=forward dst-port=445 in-interface=ether4-WAN \
    ip-protocol=udp mac-protocol=ip
add action=drop chain=forward dst-port=3389 in-interface=ether4-WAN \
    ip-protocol=tcp mac-protocol=ip
add action=drop chain=forward dst-port=3389 in-interface=ether4-WAN \
    ip-protocol=udp mac-protocol=ip
/interface bridge port
add bridge=bridge-WAN interface=ether1-LAN
...
add disabled=yes name=raihan password=raihan12345
...
add comment="M Ridwan Other" name=mridwan password=mridwan384 profile=Others \
    server=hotspotLAN
/ip hotspot walled-garden
add dst-host=untaz.com
add dst-host=new.tazkia.ac.id
add dst-host=steitazkia.com
add dst-host=simakstei.tazkia.ac.id
add dst-host=tazkia.ac.id
add dst-host=spmb.tazkia.ac.id
/ip route
