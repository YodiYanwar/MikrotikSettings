# may/03/2017 02:44:55 by RouterOS 6.37.5
# software id = QCAW-C85R
#
/interface bridge
...
set [ find default-name=ether4 ] advertise=\
    10M-half,10M-full,100M-half,100M-full name=ether4-WAN
/ip neighbor discovery
set bridge-LAN comment="Jaringan LAN"
/interface vlan
add interface=bridge-LAN name=vlanAdmin vlan-id=11
add interface=bridge-LAN name=vlanLecturer vlan-id=44
add interface=bridge-LAN name=vlanStaff vlan-id=22
add interface=bridge-LAN name=vlanStudent vlan-id=33
...
add bridge=bridge-WAN interface=ether3-ABSEN
add bridge=bridge-WAN interface=ether4-WAN
/ip address
add address=192.168.3.1/24 comment="Jaringan LAN" interface=bridge-LAN \
    network=192.168.3.0
add address=103.60.180.186/29 comment="Internet JLM" interface=ether4-WAN \
    network=103.60.180.184
...
add action=passthrough chain=unused-hs-chain comment=\
    "place hotspot rules here" disabled=yes
add action=masquerade chain=srcnat disabled=yes out-interface=ether4-WAN
...
add address=192.168.3.245 comment="Juragan Mint" mac-address=\
    F8:1A:67:10:D4:5D server=hotspotLAN to-address=192.168.3.200 type=\
    bypassed
add address=192.168.3.120 comment=Admin mac-address=C0:3F:D5:53:14:F7 server=\
    hotspotLAN to-address=192.168.3.120
/ip hotspot user
...
add name=yodi password=yodieys94 profile=Staff server=hotspotLAN
add name=ilyas password=ilyas784 profile=Staff server=hotspotLAN
add name=rusdi password=rusdi253 profile=Pimpinan server=hotspotLAN
add comment="Hasan Ishak" name=hasan password=ishak profile=Pimpinan server=\
    hotspotLAN
add name=mimin password=mimin748 profile=Staff server=hotspotLAN
add name=ikka password=ikka395 profile=Staff server=hotspotLAN
add name=derry password=derry942 profile=Staff server=hotspotLAN
add comment="Afif Zaerofi" name=afif password=afif468 profile=Pimpinan \
    server=hotspotLAN
add name=joko password=joko205 profile=Staff server=hotspotLAN
add name=sule password=sule853 profile=Staff server=hotspotLAN
add name=nabil password=nabil953 profile=Mahasiswa server=hotspotLAN
add name=pardiman password=pardiman372 profile=Staff server=hotspotLAN
...
add name=muhlas password=muhlas739 profile=Others server=hotspotLAN
add name=atang password=atang523 profile=Others server=hotspotLAN
add name=juragan password=ei2684
add name=sri password=sri734 profile=Pembina server=hotspotLAN
add name=rajab password=rajab382 profile=Pembina server=hotspotLAN
add name=irwan password=irwan583 profile=Others server=hotspotLAN
add name=happy password=happy842 profile=Dosen server=hotspotLAN
add name=didi password=didi932 profile=Others server=hotspotLAN
add name=sani password=sani482 profile=Pembina server=hotspotLAN
add name=kemal password=kemal931 profile=Staff server=hotspotLAN
add name=hamid2 password=hamid734 profile=Pembina server=hotspotLAN
add name=Wafi password=Wafi591 profile=Mahasiswa server=hotspotLAN
add name=amughni password=amughni294 profile=Dosen server=hotspotLAN
add name=syaichu password=syaichu302 profile=Dosen server=hotspotLAN
add name=afadli password=afadli157 profile=Dosen server=hotspotLAN
add name=asnanp password=asnanp904 profile=Dosen server=hotspotLAN
add name=bohri password=bohri574 profile=Dosen server=hotspotLAN
add name=dewif password=dewif932 profile=Dosen server=hotspotLAN
add name=dodiy password=dodiy589 profile=Dosen server=hotspotLAN
add name=amisno password=amisno158 profile=Dosen server=hotspotLAN
add name=arifrahman password=arifrahman538 profile=Dosen server=hotspotLAN
add name=indra2 password=indra2795 profile=Dosen server=hotspotLAN
add name=laela password=laela112 profile=Dosen server=hotspotLAN
add name=echandra password=echandra749 profile=Dosen server=hotspotLAN
add name=endiana password=endiana625 profile=Dosen server=hotspotLAN
add name=eppy password=eppy980 profile=Dosen server=hotspotLAN
add name=grandis password=grandis347 profile=Dosen server=hotspotLAN
add name=harliani password=harliani213 profile=Dosen server=hotspotLAN
add name=hera2 password=hera2647 profile=Dosen server=hotspotLAN
add name=iris password=iris247 profile=Dosen server=hotspotLAN
add name=irospita password=irospita854 profile=Dosen server=hotspotLAN
add name=khairunisa password=khairunisa483 profile=Dosen server=hotspotLAN
add name=surur password=surur682 profile=Dosen server=hotspotLAN
add name=isa32 password=isa3256 profile=Dosen server=hotspotLAN
add name=muah password=muah4945 profile=Dosen server=hotspotLAN
add name=nasher2 password=nasher2295 profile=Dosen server=hotspotLAN
add name=sopyanm password=sopyanm534 profile=Dosen server=hotspotLAN
add name=shadi password=shadi935 profile=Dosen server=hotspotLAN
add name=ufauzi password=ufauzi000 profile=Dosen server=hotspotLAN
add name=wisnu password=wisnu856 profile=Dosen server=hotspotLAN
...
add name=andi2 password=andi248 profile=Others server=hotspotLAN
add name=wahyudi2 password=wahyudi239 profile=Others server=hotspotLAN
add name=anwar2 password=anwar295 profile=Pembina server=hotspotLAN
add name=syairul password=syairul643 profile=Dosen server=hotspotLAN
add name=sunarya password=sunarya466 profile=Dosen server=hotspotLAN
add name=joni password=joni495 profile=Dosen server=hotspotLAN
add name=rizaludin password=rizaludin126 profile=Dosen server=hotspotLAN
add name=hanik password=hanik684 profile=Dosen server=hotspotLAN
add name=hendi2 password=hendi245 profile=Others server=hotspotLAN
add name=syahrul2 password=syahrul203 profile=Others server=hotspotLAN
add name=mhsatas password=mhsatas123 profile="Mahasiswa Atas" server=\
    hotspotLAN
add name=oki password=oki523 profile=Staff server=hotspotLAN
add name=m.isa password=isa222 profile=Dosen server=hotspotLAN
add disabled=yes name=ahmad23 password=ahmad237 server=hotspotLAN
add name=nano password=nano452 profile=Others server=hotspotLAN
add name=wildan1 password=wildan246 profile=Others server=hotspotLAN
add name=rafly1 password=mumu99 profile=Others server=hotspotLAN
add name=berry password=berry profile=Others server=hotspotLAN
add name=amal password=amal123 profile=Others server=hotspotLAN
...
add name=rahman password=rahman851 profile=Mahasiswa server=hotspotLAN
...
add name=fardhan password=fardhan423 profile=Mahasiswa server=hotspotLAN
...
add name=Afifah password=Afifah357 profile=Mahasiswa server=hotspotLAN
...
add comment="Neng Sri Hartati" name=neng password=srih profile=Staff server=\
    hotspotLAN
add name=siti password=siti637 profile=Staff server=hotspotLAN
/ip route
add check-gateway=ping distance=1 gateway=103.60.180.185
/system identity
set name=GWTazkiaDramaga
/system ntp client
set enabled=yes primary-ntp=128.138.141.172 secondary-ntp=129.6.15.30
